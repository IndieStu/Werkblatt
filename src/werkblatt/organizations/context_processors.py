...
def organization(request):
    ...
    return {
        ...
        "software_source_code_url": settings.SOFTWARE_SOURCE_CODE_URL,
        "software_build_version": settings.SOFTWARE_BUILD_VERSION,
        "software_license_expression": settings.SOFTWARE_LICENSE_EXPRESSION,
        "software_license_url": settings.SOFTWARE_LICENSE_URL,
